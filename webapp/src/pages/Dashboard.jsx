...
import { Stack, Grid, Card, CardContent, Box, Typography, CardHeader, colors, Button } from '@mui/material'
...
const VaccinatedChart = ({chartData}) => {
    ...
    const data = {
        labels: [
            ...
            `Upper 2 dose ${Math.floor(chartData.userWithAboveTwoDose / chartData.totalUser * 100)}%`,
